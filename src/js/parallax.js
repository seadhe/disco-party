...
export function initParallax() {
    ...
    tiltElements.forEach(el => {
        ...
        // Set up interactive 3D Tilt Card & Mouse sway effects
        let rotX = 0, rotY = 0;
        ...
        el.addEventListener('mousemove', (e) => {
            ...
            // Max angle limit
            const maxAngle = el.classList.contains('dossier-box') ? 4 : 9;
        ...
        function animateTilt() {
            ...
            let depth = 22;
            if (el.classList.contains('arch')) depth = 28;
            if (el.classList.contains('tcard')) depth = 32;
            if (el.classList.contains('tix')) depth = 36;
